...
- V1 runner surfaces are Codex Automations, Claude `/loop`, and the local foreground supervisor. System cron installation and GitHub Actions scheduling are outside V1.
