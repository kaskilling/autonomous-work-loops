...
Manual user trial is ready on the local foreground supervisor path. Codex Automations and Claude `/loop` should not be documented or generated as V1 setup paths. The author-only strict rejection evidence from T2/T3/T4 is accepted for `87ff8c3`; do not reopen it unless strict-trust semantics change.
