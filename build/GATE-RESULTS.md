...
| V1 context contract | setup/runtime context | STATIC PASS; NEEDS LIVE RERUN | Bootstrap now renders `.agent-loops/context.md`; guarded runner prompts include repo root, bounded context, repo instruction file list, and generated-path guardrails for Implementer/Reviewer/Fixer |
