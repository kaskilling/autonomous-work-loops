...
create_label ready-for-human 5319E7 "Proof, green hosted checks, and autonomous review converged"
create_label ready-for-human-baseline-red 8A63D2 "Proof and review converged; hosted failures match default-branch baseline"
