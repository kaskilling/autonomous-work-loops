  ...
  "plugins": [
    {
      ...
      "source": { "source": "git", "url": "https://github.com/<you>/autonomous-work-loops.git", "ref": "v0.1.1" },
      "category": "automation"
    }
  ]
}
...
Pin `ref` to the **tag** (`v0.1.1`), not a moving branch — this is autonomous code that runs with credentials, so updates should be deliberate.
